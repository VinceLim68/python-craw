...
url = 'http://xm.lianjia.com/ershoufang/pg8/'
html_cont = downloader.download(url,False,True)
# print(html_cont)
soup = BeautifulSoup(html_cont,'lxml',from_encoding='urf-8')

# pages = soup.select('div.house-lst-page-box')
# print(pages)
# print(pages[0].get('page-url'))
# page = eval(pages[0].get('page-data'))
# print(page)
...
# comms = soup.select("div.houseInfo > a")
# for info,title in zip(houseinfo,titles):
