...
include_once './PHPExcel_1.8.0/Classes/PHPExcel/Writer/Excel5.php';
...
$objPHPExcel->getActiveSheet()->SetCellValue('B2', '一');
$objPHPExcel->getActiveSheet()->SetCellValue('C2', '二');
